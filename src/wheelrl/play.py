"""Visualize a neutral controller or a trained WheelRL policy."""
...
def main() -> None:
    ...
    base_env = B2WZ1Env(render_mode="human", command_curriculum=0.0)
    ...
    try:
        while time.monotonic() < deadline:
            ...
            if vec_env is not None:
                observation, _, _, _ = vec_env.step(action)
            else:
                observation, _, terminated, truncated, _ = base_env.step(action)
